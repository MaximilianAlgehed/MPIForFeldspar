...
broadcastGather = do
            ...
            dsize <- newArr 1                            -- Initialize the size variabl
            on root (setArr dsize 0 (15 :: Data Word32)) -- "Read" the size from the user...
            bcast dsize 1 0 mpi_comm_world               -- bcast the size
            ...
            onAllBut root $ bcast dataArr arrSize root mpi_comm_world
            ...
            onAllBut root $ gatherSend resultV root mpi_comm_world
